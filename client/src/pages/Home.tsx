    ...
    <div className="min-h-screen bg-background flex flex-col font-sans">
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground font-mono">
                Consumer Footwear Analysis Database
              </p>
            </div>
          </button>
      ...
      <main className="flex-1 container py-6 overflow-x-auto">
          ...
          <Table>
            <TableHeader className="bg-muted/30">
              <TableRow className="hover:bg-transparent border-b-2 border-border">
                ...
                <TableHead className="w-[45px] font-bold text-foreground border-r border-border/50">
                  #
                </TableHead>
                <TableHead
                ...
                >
                  <div className="flex items-center justify-end">
                    RESALE {getSortIcon("resalePrice")}
                  </div>
                </TableHead>
                <TableHead
                  className="w-[100px] font-bold text-foreground cursor-pointer hover:bg-accent/50 border-r border-border/50 text-right"
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="border-r border-border/50">
                      <Badge
                        variant="outline"
                        className="rounded-none border-foreground/30 font-normal text-xs"
                      >
                    ...
                    <TableCell
                      className={`text-right border-r border-border/50 ${getPremiumColor(
                        sneaker.premium
                      )}`}
                    >
                      {sneaker.premium > 0 ? "+" : ""}
                    ...
                    <TableCell className="text-center">
                      <Dialog>
                        ...
                        <DialogContent className="max-w-4xl rounded-none border-2 border-border shadow-hard bg-card p-0 overflow-hidden max-h-[90vh] overflow-y-auto">
                          <SneakerDetailDialog sneaker={sneaker} />
                        </DialogContent>
                      </Dialog>
                    </TableCell>
                  </TableRow>
        ...
        <div className="mt-4 flex justify-between items-center text-xs font-mono text-muted-foreground">
          <div>SHOWING {filteredData.length} OF {sneakersData.length} MODELS</div>
          <div>DATA SOURCE: MARKET ANALYSIS 2025-2026</div>
        </div>
      </main>
    ...
    <>
      ...
      <Tabs defaultValue="overview" className="w-full">
        <TabsList className="w-full rounded-none border-b-2 border-border bg-muted/20 grid grid-cols-3 sticky top-[100px] z-10">
          <TabsTrigger value="overview" className="rounded-none data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
            OVERVIEW
          </TabsTrigger>
          <TabsTrigger value="reviews" className="rounded-none data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
            REVIEWS ({totalReviews})
          </TabsTrigger>
          <TabsTrigger value="specs" className="rounded-none data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">
            SPECS
          </TabsTrigger>
        </TabsList>
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-muted/10 p-4 border border-border/20 font-mono text-sm leading-relaxed">
                  <p className="mb-2">
                    <span className="font-bold">Cushioning:</span>{" "}
                    {sneaker.cushioning}
                  </p>
                  <p className="mb-2">
                    <span className="font-bold">Features:</span>{" "}
                    {sneaker.techFeatures}
                  </p>
                  <p>
                    <span className="font-bold">Primary Use:</span>{" "}
                    {sneaker.use}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div className="border-l-4 border-primary pl-4">
                ...
                <p className="font-mono text-sm">{sneaker.techFeatures}</p>
              </div>
              ...
              <div className="border-l-4 border-secondary pl-4">
                ...
                <p className="font-mono text-sm">{sneaker.cushioning}</p>
              </div>
              ...
              <div className="border-l-4 border-accent pl-4">
                ...
                <p className="font-mono text-sm">{sneaker.use}</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-primary pl-4">
                ...
                <p className="font-mono text-sm">{sneaker.style}</p>
              </div>
              ...
              <div className="border-l-4 border-secondary pl-4">
                ...
                <p className="font-mono text-sm">{sneaker.colorways}</p>
              </div>
              ...
              <div className="border-l-4 border-accent pl-4">
                ...
                <p className="font-mono text-sm">{sneaker.collaboration}</p>
              </div>
            </div>
          </div>
        </TabsContent>
